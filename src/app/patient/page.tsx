...
export default function PatientPage() {
  ...
  const payload = useMemo<CaseInput>(
    () => ({
      ...
      sex: sampleCaseInput.sex,
      age: sampleCaseInput.age,
      histology: sampleCaseInput.histology,
      biomarkers: sampleCaseInput.biomarkers,
      comorbidities: sampleCaseInput.comorbidities,
      prior_surgeries: sampleCaseInput.prior_surgeries,
      radiation_history: sampleCaseInput.radiation_history,
      labs: sampleCaseInput.labs,
      contraindications: sampleCaseInput.contraindications,
      as_of_date: asOfDate,
